...
export default function AnalyticsTable({
  ...
  useEffect(() => {
    const rootHeight = document.getElementById(
      "analytics-table-root"
    )?.clientHeight;
    const headHeight = document
      .getElementsByClassName("analytics-table-head")
      ?.item(0)?.clientHeight;
    const rowHeight = document
      .getElementsByClassName("analytics-table-row")
      ?.item(0)?.clientHeight;
    const paginationHeight = document
      .getElementsByClassName("analytics-table-pagination")
      ?.item(0)?.clientHeight;

    if (rootHeight && headHeight && rowHeight && paginationHeight) {
      setRowsPerPage(
        Math.floor((rootHeight - headHeight - paginationHeight) / rowHeight)
      );
    }
  }, []);
                  ...
                  return (
                    ...
                    >
                      <TableCell id={labelId} scope="row" align="left">
                        <span style={{ background: "#ECECEC", padding: 4 }}>
