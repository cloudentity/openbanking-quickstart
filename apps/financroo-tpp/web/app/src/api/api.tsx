...
export const api = {
  ...
  connectBank: (bankId, body) =>
    base.post({ url: `/connect/${bankId}`, body, query: {} }),
  domesticPaymentConsent: body =>
    base.post({ url: `/domestic-payment-consent`, body, query: {} }),
  disconnectBank: bankId =>
    base.delete({ url: `/disconnect/${bankId}`, query: {} }),
