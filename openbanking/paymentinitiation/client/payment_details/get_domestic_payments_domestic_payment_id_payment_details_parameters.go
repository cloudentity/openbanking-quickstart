...
// NewGetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams creates a new GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams object,
...
func NewGetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams() *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
	return &GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDomesticPaymentsDomesticPaymentIDPaymentDetailsParamsWithTimeout creates a new GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams object
...
// NewGetDomesticPaymentsDomesticPaymentIDPaymentDetailsParamsWithContext creates a new GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams object
...
// NewGetDomesticPaymentsDomesticPaymentIDPaymentDetailsParamsWithHTTPClient creates a new GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams object
...
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithDefaults() *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get domestic payments domestic payment Id payment details params
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithTimeout(timeout time.Duration) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get domestic payments domestic payment Id payment details params
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get domestic payments domestic payment Id payment details params
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithContext(ctx context.Context) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get domestic payments domestic payment Id payment details params
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get domestic payments domestic payment Id payment details params
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithHTTPClient(client *http.Client) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get domestic payments domestic payment Id payment details params
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAuthorization adds the authorization to the get domestic payments domestic payment Id payment details params
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithAuthorization(authorization string) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
...
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithDomesticPaymentID(domesticPaymentID string) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
...
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithXCustomerUserAgent(xCustomerUserAgent *string) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
...
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithXFapiAuthDate(xFapiAuthDate *string) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
...
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithXFapiCustomerIPAddress(xFapiCustomerIPAddress *string) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
...
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WithXFapiInteractionID(xFapiInteractionID *string) *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams {
...
func (o *GetDomesticPaymentsDomesticPaymentIDPaymentDetailsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
