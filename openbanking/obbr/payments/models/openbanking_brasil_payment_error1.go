...
// OpenbankingBrasilPaymentError1 Error1
//
// swagger:model OpenbankingBrasilPaymentError1
type OpenbankingBrasilPaymentError1 struct {

	// code
	// Required: true
	Code *OpenbankingBrasilPaymentEnumErrorsCreatePayment `json:"code"`
...
// Validate validates this openbanking brasil payment error1
func (m *OpenbankingBrasilPaymentError1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentError1) validateCode(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentError1) validateDetail(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentError1) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil payment error1 based on the context it is used
func (m *OpenbankingBrasilPaymentError1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentError1) contextValidateCode(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentError1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilPaymentError1) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentError1
