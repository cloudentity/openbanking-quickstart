...
// OpenbankingBrasilCreditorAccount CreditorAccount
//
// Objeto que contm a identificao da conta de destino do beneficirio/recebedor.
//
// swagger:model OpenbankingBrasilCreditorAccount
type OpenbankingBrasilCreditorAccount struct {
...
// Validate validates this openbanking brasil creditor account
func (m *OpenbankingBrasilCreditorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilCreditorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreditorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreditorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreditorAccount) validateNumber(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil creditor account based on the context it is used
func (m *OpenbankingBrasilCreditorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilCreditorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreditorAccount) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilCreditorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilCreditorAccount
