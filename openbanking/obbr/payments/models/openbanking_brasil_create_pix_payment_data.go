...
// OpenbankingBrasilCreatePixPaymentData CreatePixPaymentData
//
// Objeto contendo dados do pagamento e do recebedor (creditor).
//
// swagger:model OpenbankingBrasilCreatePixPaymentData
type OpenbankingBrasilCreatePixPaymentData struct {
...
// Validate validates this openbanking brasil create pix payment data
func (m *OpenbankingBrasilCreatePixPaymentData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilCreatePixPaymentData) validateCreditorAccount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) validateLocalInstrument(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) validatePayment(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) validateProxy(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) validateQrCode(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) validateRemittanceInformation(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil create pix payment data based on the context it is used
func (m *OpenbankingBrasilCreatePixPaymentData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilCreatePixPaymentData) contextValidateCreditorAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) contextValidateLocalInstrument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) contextValidatePayment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilCreatePixPaymentData) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilCreatePixPaymentData) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilCreatePixPaymentData
