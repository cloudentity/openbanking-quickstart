...
// WithIsOwned adds the isOwned to the list accounts params
func (o *ListAccountsParams) WithIsOwned(isOwned *bool) *ListAccountsParams {
	o.SetIsOwned(isOwned)
	return o
}

// SetIsOwned adds the isOwned to the list accounts params
func (o *ListAccountsParams) SetIsOwned(isOwned *bool) {
	o.IsOwned = isOwned
}

// WithOpenStatus adds the openStatus to the list accounts params
func (o *ListAccountsParams) WithOpenStatus(openStatus *string) *ListAccountsParams {
	o.SetOpenStatus(openStatus)
	return o
}

// SetOpenStatus adds the openStatus to the list accounts params
func (o *ListAccountsParams) SetOpenStatus(openStatus *string) {
	o.OpenStatus = openStatus
}

// WithPage adds the page to the list accounts params
func (o *ListAccountsParams) WithPage(page *int32) *ListAccountsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the list accounts params
func (o *ListAccountsParams) SetPage(page *int32) {
	o.Page = page
}

// WithPageSize adds the pageSize to the list accounts params
func (o *ListAccountsParams) WithPageSize(pageSize *int32) *ListAccountsParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the list accounts params
func (o *ListAccountsParams) SetPageSize(pageSize *int32) {
	o.PageSize = pageSize
}

// WithProductCategory adds the productCategory to the list accounts params
func (o *ListAccountsParams) WithProductCategory(productCategory *string) *ListAccountsParams {
	o.SetProductCategory(productCategory)
	return o
}

// SetProductCategory adds the productCategory to the list accounts params
func (o *ListAccountsParams) SetProductCategory(productCategory *string) {
	o.ProductCategory = productCategory
}

// WithXCdsClientHeaders adds the xCdsClientHeaders to the list accounts params
func (o *ListAccountsParams) WithXCdsClientHeaders(xCdsClientHeaders *string) *ListAccountsParams {
	o.SetXCdsClientHeaders(xCdsClientHeaders)
	return o
}

// SetXCdsClientHeaders adds the xCdsClientHeaders to the list accounts params
func (o *ListAccountsParams) SetXCdsClientHeaders(xCdsClientHeaders *string) {
	o.XCdsClientHeaders = xCdsClientHeaders
}

// WithXFapiAuthDate adds the xFapiAuthDate to the list accounts params
func (o *ListAccountsParams) WithXFapiAuthDate(xFapiAuthDate *string) *ListAccountsParams {
	o.SetXFapiAuthDate(xFapiAuthDate)
	return o
}

// SetXFapiAuthDate adds the xFapiAuthDate to the list accounts params
func (o *ListAccountsParams) SetXFapiAuthDate(xFapiAuthDate *string) {
	o.XFapiAuthDate = xFapiAuthDate
}

// WithXFapiCustomerIPAddress adds the xFapiCustomerIPAddress to the list accounts params
func (o *ListAccountsParams) WithXFapiCustomerIPAddress(xFapiCustomerIPAddress *string) *ListAccountsParams {
	o.SetXFapiCustomerIPAddress(xFapiCustomerIPAddress)
	return o
}

// SetXFapiCustomerIPAddress adds the xFapiCustomerIpAddress to the list accounts params
func (o *ListAccountsParams) SetXFapiCustomerIPAddress(xFapiCustomerIPAddress *string) {
	o.XFapiCustomerIPAddress = xFapiCustomerIPAddress
}

// WithXFapiInteractionID adds the xFapiInteractionID to the list accounts params
func (o *ListAccountsParams) WithXFapiInteractionID(xFapiInteractionID *string) *ListAccountsParams {
	o.SetXFapiInteractionID(xFapiInteractionID)
	return o
}

// SetXFapiInteractionID adds the xFapiInteractionId to the list accounts params
func (o *ListAccountsParams) SetXFapiInteractionID(xFapiInteractionID *string) {
	o.XFapiInteractionID = xFapiInteractionID
}

// WithXMinv adds the xMinv to the list accounts params
func (o *ListAccountsParams) WithXMinv(xMinv *string) *ListAccountsParams {
	o.SetXMinv(xMinv)
	return o
}

// SetXMinv adds the xMinV to the list accounts params
func (o *ListAccountsParams) SetXMinv(xMinv *string) {
	o.XMinv = xMinv
}

// WithXv adds the xv to the list accounts params
func (o *ListAccountsParams) WithXv(xv string) *ListAccountsParams {
	o.SetXv(xv)
	return o
}

// SetXv adds the xV to the list accounts params
func (o *ListAccountsParams) SetXv(xv string) {
	o.Xv = xv
}
