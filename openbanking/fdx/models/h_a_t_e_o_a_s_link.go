...
// Validate validates this h a t e o a s link
...
func (m *HATEOASLink) validateAction(formats strfmt.Registry) error {
...
func (m *HATEOASLink) validateHref(formats strfmt.Registry) error {
...
func (m *HATEOASLink) validateTypes(formats strfmt.Registry) error {
...
// ContextValidate validate this h a t e o a s link based on the context it is used
...
func (m *HATEOASLink) contextValidateAction(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HATEOASLink) contextValidateTypes(ctx context.Context, formats strfmt.Registry) error {
