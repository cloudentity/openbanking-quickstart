...
//
// swagger:model AccountContactentity
type AccountContactentity struct {
...
// Validate validates this account contactentity
func (m *AccountContactentity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AccountContactentity) validateAddresses(formats strfmt.Registry) error {
...
func (m *AccountContactentity) validateHolders(formats strfmt.Registry) error {
...
func (m *AccountContactentity) validateTelephones(formats strfmt.Registry) error {
...
// ContextValidate validate this account contactentity based on the context it is used
func (m *AccountContactentity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountContactentity) contextValidateAddresses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccountContactentity) contextValidateHolders(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccountContactentity) contextValidateTelephones(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccountContactentity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AccountContactentity) UnmarshalBinary(b []byte) error {
	var res AccountContactentity
