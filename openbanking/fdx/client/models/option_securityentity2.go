...
// OptionSecurityentity2 OptionSecurityentity2
//
// An option security
//
// swagger:model OptionSecurityentity2
type OptionSecurityentity2 struct {
...
// Validate validates this option securityentity2
func (m *OptionSecurityentity2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OptionSecurityentity2) validateExpireDate(formats strfmt.Registry) error {
...
func (m *OptionSecurityentity2) validateOptionType(formats strfmt.Registry) error {
...
func (m *OptionSecurityentity2) validateSecured(formats strfmt.Registry) error {
...
// ContextValidate validate this option securityentity2 based on the context it is used
func (m *OptionSecurityentity2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OptionSecurityentity2) contextValidateOptionType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OptionSecurityentity2) contextValidateSecured(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OptionSecurityentity2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OptionSecurityentity2) UnmarshalBinary(b []byte) error {
	var res OptionSecurityentity2
