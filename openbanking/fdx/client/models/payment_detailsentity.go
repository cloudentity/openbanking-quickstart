...
//
// swagger:model PaymentDetailsentity
type PaymentDetailsentity struct {
...
// Validate validates this payment detailsentity
func (m *PaymentDetailsentity) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this payment detailsentity based on context it is used
func (m *PaymentDetailsentity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PaymentDetailsentity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PaymentDetailsentity) UnmarshalBinary(b []byte) error {
	var res PaymentDetailsentity
