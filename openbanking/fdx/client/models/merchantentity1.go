...
// Validate validates this merchantentity1
func (m *Merchantentity1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Merchantentity1) validateAddress(formats strfmt.Registry) error {
...
func (m *Merchantentity1) validateExpiresTimestamp(formats strfmt.Registry) error {
...
func (m *Merchantentity1) validateName(formats strfmt.Registry) error {
...
func (m *Merchantentity1) validatePayeeID(formats strfmt.Registry) error {
...
func (m *Merchantentity1) validatePhone(formats strfmt.Registry) error {
...
func (m *Merchantentity1) validateStatus(formats strfmt.Registry) error {
...
// ContextValidate validate this merchantentity1 based on the context it is used
func (m *Merchantentity1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Merchantentity1) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Merchantentity1) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Merchantentity1) contextValidatePhone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Merchantentity1) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Merchantentity1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Merchantentity1) UnmarshalBinary(b []byte) error {
	var res Merchantentity1
