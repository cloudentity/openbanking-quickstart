...
// PaymentForUpdateentity1 PaymentForUpdateentity1
//
// The data of the Payment to be scheduled
//
// swagger:model PaymentForUpdateentity1
type PaymentForUpdateentity1 struct {
...
// Validate validates this payment for updateentity1
func (m *PaymentForUpdateentity1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentForUpdateentity1) validateAmount(formats strfmt.Registry) error {
...
func (m *PaymentForUpdateentity1) validateDueDate(formats strfmt.Registry) error {
...
func (m *PaymentForUpdateentity1) validateFromAccountID(formats strfmt.Registry) error {
...
func (m *PaymentForUpdateentity1) validateToPayeeID(formats strfmt.Registry) error {
...
// ContextValidate validates this payment for updateentity1 based on context it is used
func (m *PaymentForUpdateentity1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PaymentForUpdateentity1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PaymentForUpdateentity1) UnmarshalBinary(b []byte) error {
	var res PaymentForUpdateentity1
