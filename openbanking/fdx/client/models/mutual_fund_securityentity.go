...
// MutualFundSecurityentity MutualFundSecurityentity
//
// A mutual fund
//
// swagger:model MutualFundSecurityentity
type MutualFundSecurityentity struct {
...
// Validate validates this mutual fund securityentity
func (m *MutualFundSecurityentity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MutualFundSecurityentity) validateMutualFundType(formats strfmt.Registry) error {
...
func (m *MutualFundSecurityentity) validateYieldAsOfDate(formats strfmt.Registry) error {
...
// ContextValidate validate this mutual fund securityentity based on the context it is used
func (m *MutualFundSecurityentity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MutualFundSecurityentity) contextValidateMutualFundType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MutualFundSecurityentity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MutualFundSecurityentity) UnmarshalBinary(b []byte) error {
	var res MutualFundSecurityentity
