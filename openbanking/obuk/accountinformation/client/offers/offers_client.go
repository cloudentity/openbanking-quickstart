...
type ClientService interface {
	GetAccountsAccountIDOffers(params *GetAccountsAccountIDOffersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDOffersOK, error)
...
*/
func (a *Client) GetAccountsAccountIDOffers(params *GetAccountsAccountIDOffersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDOffersOK, error) {
