...
type ClientService interface {
	GetAccountsAccountIDScheduledPayments(params *GetAccountsAccountIDScheduledPaymentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDScheduledPaymentsOK, error)

	GetScheduledPayments(params *GetScheduledPaymentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetScheduledPaymentsOK, error)
...
*/
func (a *Client) GetAccountsAccountIDScheduledPayments(params *GetAccountsAccountIDScheduledPaymentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDScheduledPaymentsOK, error) {
...
*/
func (a *Client) GetScheduledPayments(params *GetScheduledPaymentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetScheduledPaymentsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
