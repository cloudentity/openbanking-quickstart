...
export const putTokenInStore = (token, name = ACCESS_TOKEN_KEY) =>
  localStorage.setItem(name, token);
export const removeTokenFromStore = () =>
  localStorage.removeItem(ACCESS_TOKEN_KEY);

export const getExpiresInFromStore = () => localStorage.getItem(EXPIRES_IN_KEY);
export const putExpiresInInStore = (token, name = EXPIRES_IN_KEY) =>
  localStorage.setItem(name, token);
export const removeExpiresInFromStore = () =>
  localStorage.removeItem(EXPIRES_IN_KEY);

export const getIATInFromStore = () => localStorage.getItem(IAT_KEY);
export const putIATInInStore = (token, name = IAT_KEY) =>
  localStorage.setItem(name, token);
...
export const putIdTokenInStore = (token, name = ID_TOKEN_KEY) =>
  localStorage.setItem(name, token);
export const removeIdTokenFromStore = () =>
