...
type ClientService interface {
	GetAccountsAccountIDStatementsStatementIDTransactions(params *GetAccountsAccountIDStatementsStatementIDTransactionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDStatementsStatementIDTransactionsOK, error)

	GetAccountsAccountIDTransactions(params *GetAccountsAccountIDTransactionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDTransactionsOK, error)
...
*/
func (a *Client) GetAccountsAccountIDStatementsStatementIDTransactions(params *GetAccountsAccountIDStatementsStatementIDTransactionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDStatementsStatementIDTransactionsOK, error) {
...
*/
func (a *Client) GetAccountsAccountIDTransactions(params *GetAccountsAccountIDTransactionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountsAccountIDTransactionsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
