...
//
// swagger:model BankingTransaction
...
// Validate validates this banking transaction
func (m *BankingTransaction) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BankingTransaction) validateAccountID(formats strfmt.Registry) error {
...
func (m *BankingTransaction) validateAmount(formats strfmt.Registry) error {
...
func (m *BankingTransaction) validateDescription(formats strfmt.Registry) error {
...
func (m *BankingTransaction) validateIsDetailAvailable(formats strfmt.Registry) error {
...
func (m *BankingTransaction) validateReference(formats strfmt.Registry) error {
...
func (m *BankingTransaction) validateStatus(formats strfmt.Registry) error {
...
func (m *BankingTransaction) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this banking transaction based on the context it is used
func (m *BankingTransaction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BankingTransaction) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BankingTransaction) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BankingTransaction) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BankingTransaction) UnmarshalBinary(b []byte) error {
	var res BankingTransaction
