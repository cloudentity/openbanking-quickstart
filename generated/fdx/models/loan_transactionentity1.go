...
// LoanTransactionentity1 LoanTransactionentity1
//
// A loan transaction
//
// swagger:model LoanTransactionentity1
type LoanTransactionentity1 struct {
...
// Validate validates this loan transactionentity1
func (m *LoanTransactionentity1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LoanTransactionentity1) validateAccountID(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateDebitCreditMemo(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateFiAttributes(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateForeignCurrency(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateLineItem(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateLinks(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateMemo(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validatePaymentDetails(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validatePostedTimestamp(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateReferenceTransactionID(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateReward(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateStatus(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateTransactionID(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateTransactionTimestamp(formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) validateTransactionType(formats strfmt.Registry) error {
...
// ContextValidate validate this loan transactionentity1 based on the context it is used
func (m *LoanTransactionentity1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LoanTransactionentity1) contextValidateDebitCreditMemo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidateFiAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidateForeignCurrency(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidateLineItem(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidatePaymentDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidateReward(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) contextValidateTransactionType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoanTransactionentity1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LoanTransactionentity1) UnmarshalBinary(b []byte) error {
	var res LoanTransactionentity1
