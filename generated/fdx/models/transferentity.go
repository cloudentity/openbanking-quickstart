...
type Transferentity struct {
	...
	// Format: date-time
	TransferTime strfmt.DateTime `json:"transferTime,omitempty"`
}

// Validate validates this transferentity
func (m *Transferentity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Transferentity) validateFromAccountID(formats strfmt.Registry) error {
...
func (m *Transferentity) validateMemo(formats strfmt.Registry) error {
...
func (m *Transferentity) validatePaymentDetails(formats strfmt.Registry) error {
...
func (m *Transferentity) validateReferenceID(formats strfmt.Registry) error {
...
func (m *Transferentity) validateStatus(formats strfmt.Registry) error {
...
func (m *Transferentity) validateToAccountID(formats strfmt.Registry) error {
...
func (m *Transferentity) validateTransferID(formats strfmt.Registry) error {
...
func (m *Transferentity) validateTransferTime(formats strfmt.Registry) error {
	if swag.IsZero(m.TransferTime) { // not required
		return nil
	}

	if err := validate.FormatOf("transferTime", "body", "date-time", m.TransferTime.String(), formats); err != nil {
		return err
	}
...
// ContextValidate validate this transferentity based on the context it is used
func (m *Transferentity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Transferentity) contextValidatePaymentDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Transferentity) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Transferentity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Transferentity) UnmarshalBinary(b []byte) error {
	var res Transferentity
